...
insert into personas (id_persona, nombre, apellido) values (0x8E4FFF536C6611EF9A0E503EAAE34948, 'Agustín', 'Ramos');
insert into users (enabled, id_persona, username, password) values (0x01, 0x8E4FFF536C6611EF9A0E503EAAE34948, 'admin', 'admin');
...
INSERT INTO patologias (id, nombre_patologia) VALUES
                                             (UUID_TO_BIN(UUID()), 'Diabetes'),
                                             (UUID_TO_BIN(UUID()), 'Asma'),
                                             (UUID_TO_BIN(UUID()), 'Alergia al gluten');