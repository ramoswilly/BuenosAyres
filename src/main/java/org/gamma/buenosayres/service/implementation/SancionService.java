...
import org.gamma.buenosayres.dao.interfaces.SancionDAO;
...
public class SancionService {
	...
	@Autowired
	public SancionService(SancionDAO sancionDAO, AlumnoDAO alumnoDAO)
	{
	...
	{
		Optional<Alumno> alumno = alumnoDAO.findById(dto.getAlumnoId());
